...
function FileCard({
    ...
    return (
        <div className="max-w-44 max-h-44 aspect-square text-textCol flex flex-col gap-3 bg-glass bg-opacity-10 border border-borderCol border-opacity-25 p-2 rounded-lg overflow-hidden">
